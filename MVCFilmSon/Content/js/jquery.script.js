$(document).ready(function () {
    ...
    $("#form_yil").change(function () {
        ...
        var adresYil = window.location.href;
        adresYil = adresYil.substring(0, adresYil.indexOf("?"));
        window.location.href = adresYil + "?y=" + secilenYil;
    });
    
    /*sayfa gösterim için li lere müdahale*/

    $(".pagination li").each(function () {  //li lerin herbiri için demek
